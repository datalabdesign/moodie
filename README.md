...
| MOODIE Web Companion | Organização do projeto, importação de imagens/metadados, amostragem, extração de features, labels/captions e exportação `.moodie` | Google Colab / Python |
